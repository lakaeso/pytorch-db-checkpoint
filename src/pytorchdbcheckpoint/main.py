...
class PostgresHandler:
    ...
    def save_training_state(self, epoch, model_name, model_state_dict, optim_state_dict, comment, metrics_str, *args, **kwargs):
    ...
    @_connection_decorator
    def load_training_state_last_epoch(self, model_name, *args, **kwargs):
    ...
    @_connection_decorator
    def load_training_state_last_entry(self, model_name, *args, **kwargs):
